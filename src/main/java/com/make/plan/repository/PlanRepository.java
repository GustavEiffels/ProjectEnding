...
public interface PlanRepository extends JpaRepository<Plan, Long> {
    @Query(value = "select * from Plan where code= :code and start BETWEEN DATE_ADD(:currewntDate, INTERVAL -1 MONTH) And DATE_ADD(:currentDate, INTERVAL 1 MONTH)", nativeQuery = true)
